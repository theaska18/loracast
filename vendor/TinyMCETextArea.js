...
Ext.define('Ext.ux.form.TinyMCETextArea', {
        ...
        me.tinyMCEConfig.setup = function (ed) {
            ...
            ed.on('init', function(e) {
                ...
                if(height) {
                  ...
                  setTimeout(function () { me.syncEditorHeight(height); }, 1000);
                }
            });
			...
			// ed.on('keyup', function(e) {
				...
				// if(e.keyCode == 86 && ( nav? e.metaKey : e.ctrlKey)){
					// // alert();
					// console.log(e);
    ...
    getEditor: function () {
        var me = this;
		// var editorWindow=this.getEditorO
		// return this;
    },
    //-----------------------------------------------------------------
