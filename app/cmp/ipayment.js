...
Ext.define('IPayment',{
	...
	initComponent:function(){
		...
		this.columns=[
			...
			{ text: 'Waktu/Tanggal',width:150,dataIndex: 'f1',align:'center',menuDisabled:true,sortable:false},
			{ text: 'Deskripsi',flex:1,dataIndex: 'f2',menuDisabled:true,sortable:false,renderer: function(value,a){
			...
			{ text: 'Tagihan',width: 120,dataIndex: 'f3',menuDisabled:true,sortable:false,align:'right',xtype:'numbercolumn',
			...
			},{ text: 'Pembayaran',width: 120,dataIndex: 'f4',menuDisabled:true,sortable:false,align:'right',xtype:'numbercolumn',
				renderer: function(value,a){
					return Number(value).toLocaleString(window.navigator.language,{minimumFractionDigits:2,style: 'currency', currency:'IDR'});
				} ,summaryType:function(records){
					var sum=0;
