//itextarea
Ext.define('ICodeArea', {
	alias:'widget.icodearea',
	...
	toEditor:function(){
		var $this=this;
		importComponent(['vendor/codemirror/codemirror.js','vendor/codemirror/codemirror.css'],function(para,param2){
			var editor = CodeMirror.fromTextArea(document.getElementById($this.id+"-inputEl"), {
    				lineNumbers: true
  			});
